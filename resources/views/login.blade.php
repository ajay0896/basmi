    ...
    <header class="bg-teal-800 text-white p-4 flex justify-between items-center shadow-md relative">
        ...
        <div class="flex items-center justify-center min-h-screen font-sans">
            ...
            <div class="bg-white shadow-xl rounded-lg p-8 w-full max-w-md hover:shadow-2xl transition">
                <!-- Judul -->
                <h2 class="text-2xl font-bold text-center text-teal-700 mb-6">Asup ka Basmi</h2>
                ...
                <form action="{{ route('login.process') }}" method="POST">
                    ...
                    <div class="flex items-center justify-between mb-6 text-sm">
                        <label class="flex items-center">
                            <input type="checkbox" class="text-teal-600 mr-2"> Ingat saya
                        </label>
                    ...
                    <!-- Tombol Login -->
                    <button type="submit"
                        class="w-full bg-teal-700 text-white py-2 rounded-lg font-semibold hover:bg-teal-800 transition">Login</button>
                </form>
                ...
                <!-- Link Register -->
                <p class="text-center text-sm text-gray-600 mt-6">Belum punya akun?
                    <a href="{{route('register')}}" class="text-teal-600 font-semibold hover:underline">Daftar di sini</a>
                </p>
            </div>
        </div>
</body>
